...
public class HotelManagementController {
    ...
    HotelManagementService hotelSerivce=new HotelManagementService();
    ...
    public String addHotel(@RequestBody Hotel hotel){
        ...
        //in all other cases return SUCCESS after successfully adding the hotel to the hotelDb.
           boolean check=hotelSerivce.addHotel(hotel);
           if(check){
               return "SUCCESS";
           }
    ...
    public String getHotelWithMostFacilities(){
        ...
        String res=hotelSerivce.getHotelWithMostFacilities();
    ...
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
        ...
        int res=hotelSerivce.getTotalBookings(aadharCard);
        return res;
    }
